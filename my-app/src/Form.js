                        ...
                        <div class="form-isi">
                            ...
                            <form>
                                <div class="form-group">
                                    ...
                                    <input type="fullname" class="form-control2" id="FormControl" placeholder="   Your Full Name..." required />
                                </div>
                                <div class="form-group">
                                        <label for="FormControl">Email Address<span>*</span></label>
                                        <input type="email" class="form-control2" id="FormControl" placeholder="   example@domain.com" required />
                                </div>
                                <div class="form-group numberphone">
                                        <label for="FormControl">Phone Number<span>*</span></label>
                                        <input type="number" class="form-control2 number-phone" id="FormControl" placeholder="   08543890****" required />
                                </div>
                                <div class="form-group">
                                    <label for="FormControl">Nationality</label>
                                    <select class="form-control2 minimal" id="FormControl2" placeholder="Selected..." required>
                                ...
                                <div class="form-group">
                                    ...
                                    <br />
                                    <textarea class="form-controlarea" id="exampleFormControlTextarea1" rows="10"></textarea>
                                </div>
                                <br />
